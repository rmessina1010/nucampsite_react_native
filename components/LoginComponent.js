...
class RegisterTab extends Component {
    ...
    getImageFromCamera = async () => {
        ...
        if (cameraRollPermissions.status === 'granted' && cameraPermissions.status === 'granted') {
    ...
    getImageFromGallery = async () => {
        const cameraRollPermisions = await Permissions.askAsync(Permissions.CAMERA_ROLL);
        if (cameraRollPermisions.status === 'granted') {
